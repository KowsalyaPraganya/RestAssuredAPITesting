...
public class ExtentListenerClass implements ITestListener{
	...
	ExtentSparkReporter  extentSparkReporter;//user interface/ look & feel of the report
	...
	public void configureReport()
	{
		...
		String reportName = "PetStoreAutomationTestReport-" + timestamp + ".html"; //PetStoreAutomationTestReport-2026.03.14.10.30.20.html
...
//		
		...
		extentSparkReporter.config().setDocumentTitle("Extent Listener Report Demo");
...
// Save the report to the HTML file. Without flush() → report will not generate.
